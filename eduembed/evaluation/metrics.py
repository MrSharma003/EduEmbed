...
def hits_at_n_score(ranks, n):
    ...
    --------
    >>> import numpy as np
    >>> from eduembed.evaluation.metrics import hits_at_n_score
...
def mrr_score(ranks):
    ...
    --------
    >>> import numpy as np
    >>> from eduembed.evaluation.metrics import mrr_score
    >>> rankings = np.array([1, 12, 6, 2])
    >>> mrr_score(rankings)
    0.4375
...
def rank_score(y_true, y_pred, pos_lab=1):
    ...
    --------
    >>> import numpy as np
    >>> from eduembed.evaluation.metrics import rank_score
...
def mr_score(ranks):
    ...
    Examples
    --------
    >>> from eduembed.evaluation import mr_score
    >>> ranks= [5, 3, 4, 10, 1]
    >>> mr_score(ranks)
    4.6
