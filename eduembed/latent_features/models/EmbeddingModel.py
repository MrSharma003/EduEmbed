...
import logging
from eduembed.latent_features.loss_functions import LOSS_REGISTRY
from eduembed.latent_features.regularizers import REGULARIZER_REGISTRY
from eduembed.latent_features.optimizers import OPTIMIZER_REGISTRY, SGDOptimizer
from eduembed.latent_features.initializers import INITIALIZER_REGISTRY, DEFAULT_XAVIER_IS_UNIFORM
from eduembed.evaluation import generate_corruptions_for_fit, to_idx, generate_corruptions_for_eval, \
    hits_at_n_score, mrr_score
from eduembed.datasets import AmpligraphDatasetAdapter, NumpyDatasetAdapter
...
class EmbeddingModel(abc.ABC):
 ...
 https://docs.ampligraph.org/en/latest/dev_notes.html#dealing-with-large-graphs")
    ...
    def calibrate(self, X_pos, X_neg=None, positive_base_rate=None, batches_count=100, epochs=50):
        ...
        >>>
        >>> from eduembed.datasets import load_wn11
        >>> from eduembed.latent_features.models import TransE
        >>>
        >>> X = load_wn11()
